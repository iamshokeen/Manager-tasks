...
var VERCEL_URL   = 'https://kairos-git-main-sakshamshokeen-5950s-projects.vercel.app/api/cron/sheets-sync';
var CRON_SECRET  = 'kairos-cron-secret-2026';
...
function setupMetricsSheet() {
  ...
  // Title
  sheet.getRange('A1').setValue('KAIROS CMD — FY27 METRICS')
  ...
  sheet.getRange('A6:C13').setValues([
    ['Target Leads (FY27)',                     'insert numbers here', 'Targets.csv Grand Total'],
    ['Target L2P% (decimal)',                   'insert numbers here', 'Targets.csv Grand Total'],
    ['Target P2B% (decimal)',                   'insert numbers here', 'Targets.csv Grand Total'],
    ['Target Bookings (FY27)',                  'insert numbers here', 'Targets.csv Grand Total'],
    ['Target Gross Revenue (FY27, ₹)',          'insert numbers here', 'Targets.csv Grand Total'],
    ['Target Check-in Revenue (FY27, ₹)',       'insert numbers here', 'Targets.csv Grand Total'],  // B11
    ['Target Prospects (FY27)',                 'insert numbers here', 'Targets.csv Grand Total'],  // B12
    ['Target Booking AOV (₹)',                  'insert numbers here', 'Targets.csv Grand Total'],  // B13
  ]);
  ...
  var rows = [
    ...
    ['OTA-01','OTA Assessment','YTD Gross GMV (with Cancellations)', 'insert numbers here', 'FY27','ota_gross_gmv_ytd'],
    ['OTA-02','OTA Assessment','YTD Net GMV',                        'insert numbers here', 'FY27','ota_net_gmv_ytd'],
    ['OTA-03','OTA Assessment','Cancellation Rate',                  'FORMULA',             'FY27','ota_cancellation_rate'],
    ['OTA-04','OTA Assessment','YTD AOV (Net GMV ÷ OTA Bookings)',   'insert numbers here', 'FY27','ota_aov'],
    ['OTA-05','OTA Assessment','Channel Mix — booking.com',          'insert numbers here', 'FY27','ota_channel_bookingcom'],
    ['OTA-06','OTA Assessment','Channel Mix — Marriott',             'insert numbers here', 'FY27','ota_channel_marriott'],
    ['OTA-07','OTA Assessment','Channel Mix — MMT',                  'insert numbers here', 'FY27','ota_channel_mmt'],
    ['OTA-08','OTA Assessment','Channel Mix — Airbnb',               'insert numbers here', 'FY27','ota_channel_airbnb'],
    ...
    ['OTA-11','OTA Assessment','Region Mix — Goa',                   'insert numbers here', 'FY27','ota_region_goa'],
    ['OTA-12','OTA Assessment','Region Mix — Maharashtra',           'insert numbers here', 'FY27','ota_region_maharashtra'],
    ['OTA-13','OTA Assessment','Region Mix — North',                 'insert numbers here', 'FY27','ota_region_north'],
    ['OTA-14','OTA Assessment','Region Mix — South',                 'insert numbers here', 'FY27','ota_region_south'],
    ['OTA-15','OTA Assessment','MoM Gross GMV Growth',               'insert numbers here', 'FY27','ota_mom_growth'],
    ['OTA-16','OTA Assessment','YoY Gross GMV Growth',               'insert numbers here', 'FY27','ota_yoy_growth'],

    // Check-in GMV — rows 32–48
    ['CI-01','Check-in GMV','Check-in Revenue (Occupied Month)',     'insert numbers here', '2026-03','ci_revenue_month'],
    ['CI-02','Check-in GMV','Weekday Revenue (Month)',               'insert numbers here', '2026-03','ci_revenue_weekday_month'],
    ['CI-03','Check-in GMV','Weekend Revenue (Month)',               'insert numbers here', '2026-03','ci_revenue_weekend_month'],
    ['CI-04','Check-in GMV','Peak Revenue (Month)',                  'insert numbers here', '2026-03','ci_revenue_peak_month'],
    ['CI-05','Check-in GMV','Check-in Revenue YTD',                 'insert numbers here', 'FY27',   'ci_revenue_ytd'],     // D36
    ['CI-06','Check-in GMV','Weekday Revenue YTD',                  'insert numbers here', 'FY27',   'ci_revenue_weekday_ytd'],
    ['CI-07','Check-in GMV','Weekend Revenue YTD',                  'insert numbers here', 'FY27',   'ci_revenue_weekend_ytd'],
    ['CI-08','Check-in GMV','Peak Revenue YTD',                     'insert numbers here', 'FY27',   'ci_revenue_peak_ytd'],
    ['CI-09','Check-in GMV','ARR YTD',                              'insert numbers here', 'FY27',   'ci_arr_ytd'],
    ['CI-10','Check-in GMV','Weekday ARR YTD',                      'insert numbers here', 'FY27',   'ci_arr_weekday_ytd'],  // D41
    ['CI-11','Check-in GMV','Weekend ARR YTD',                      'insert numbers here', 'FY27',   'ci_arr_weekend_ytd'],  // D42
    ['CI-12','Check-in GMV','Peak ARR YTD',                         'insert numbers here', 'FY27',   'ci_arr_peak_ytd'],     // D43
    ['CI-13','Check-in GMV','Bedroom Night Count YTD',              'insert numbers here', 'FY27',   'ci_bn_count_ytd'],
    ['CI-14','Check-in GMV','Weekday BN Count YTD',                 'insert numbers here', 'FY27',   'ci_bn_weekday_ytd'],
    ['CI-15','Check-in GMV','Weekend BN Count YTD',                 'insert numbers here', 'FY27',   'ci_bn_weekend_ytd'],
    ['CI-16','Check-in GMV','Peak BN Count YTD',                    'insert numbers here', 'FY27',   'ci_bn_peak_ytd'],
    ['CI-17','Check-in GMV','Weekday Revenue Share %',              'insert numbers here', 'FY27',   'ci_weekday_share_pct'],

    // Funnel Health — rows 49–59
    ['FH-01','Funnel Health','Total Leads YTD',                     'insert numbers here', 'FY27','fh_total_leads'],      // D49
    ['FH-02','Funnel Health','L2P%',                                'insert numbers here', 'FY27','fh_l2p_pct'],          // D50
    ['FH-03','Funnel Health','Total Prospects YTD',                 'insert numbers here', 'FY27','fh_total_prospects'],   // D51
    ['FH-04','Funnel Health','P2B%',                                'insert numbers here', 'FY27','fh_p2b_pct'],           // D52
    ['FH-05','Funnel Health','Total Bookings YTD',                  'insert numbers here', 'FY27','fh_total_bookings'],    // D53
    ['FH-06','Funnel Health','L2B% (End-to-End Conversion)',        'insert numbers here', 'FY27','fh_l2b_pct'],
    ...
    ['FH-11','Funnel Health','CI Revenue Attainment % vs Target',   'FORMULA',             'FY27','fh_revenue_attainment'], // D59

    // Leading Indicators — rows 60–62
    ['LI-01','Leading Indicators','MoM Lead Volume Trend',          'insert numbers here', 'FY27','li_mom_lead_volume'],
    ['LI-02','Leading Indicators','MoM L2P% Trend',                 'insert numbers here', 'FY27','li_mom_l2p_trend'],
    ['LI-03','Leading Indicators','MoM P2B% Trend',                 'insert numbers here', 'FY27','li_mom_p2b_trend'],
